...
CIMGUI_API bool igBegin2(ImStr name, bool* p_opened, CONST ImVec2 size_on_first_use, float bg_alpha, ImGuiWindowFlags flags)
{
...
CIMGUI_API bool igBeginChild(ImStr str_id, CONST ImVec2 size, bool border, ImGuiWindowFlags extra_flags)
{
...
CIMGUI_API void igSetWindowPosByName(ImStr name, CONST ImVec2 pos, ImGuiSetCond cond)
{
    ImGui::SetWindowPos(name,pos,cond);
}

CIMGUI_API void igSetWindowSize2(ImStr name, CONST ImVec2 size, ImGuiSetCond cond)
{
...
CIMGUI_API void igTextColored1(CONST ImVec4 col, ImStr text)
{
...
CIMGUI_API bool igButton(ImStr label, CONST ImVec2 size)
{
...
CIMGUI_API bool igInvisibleButton(ImStr str_id, CONST ImVec2 size)
{
...
CIMGUI_API void igPlotLines(ImStr label, CONST float* values, int values_count, int values_offset, ImStr overlay_text, float scale_min, float scale_max, ImVec2 graph_size, int stride)
{
    return ImGui::PlotLines(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);
}

CIMGUI_API void igPlotLines2(ImStr label, float(*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, ImStr overlay_text, float scale_min, float scale_max, ImVec2 graph_size)
{
    return ImGui::PlotLines(label, values_getter, data, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size);
}

CIMGUI_API void igPlotHistogram(ImStr label, CONST float* values, int values_count, int values_offset, ImStr overlay_text, float scale_min, float scale_max, ImVec2 graph_size, int stride)
{
    return ImGui::PlotHistogram(label,values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);
}

CIMGUI_API void igPlotHistogram2(ImStr label, float(*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, ImStr overlay_text, float scale_min, float scale_max, ImVec2 graph_size)
{
...
CIMGUI_API bool igVSliderFloat(ImStr label, CONST ImVec2 size, float* v, float v_min, float v_max, ImStr display_format, float power)
{
    return ImGui::VSliderFloat(label, size, v, v_min, v_max, display_format, power);
}

CIMGUI_API bool igVSliderInt(ImStr label, CONST ImVec2 size, int* v, int v_min, int v_max, ImStr display_format)
{
    return ImGui::VSliderInt(label, size, v, v_min, v_max, display_format);
}

// Widgets: Drags (tip: ctrl+click on a drag box to input text)
CIMGUI_API bool igDragFloat(ImStr label, float* v, float v_speed, float v_min, float v_max, ImStr display_format, float power)
{
...
CIMGUI_API bool igDragInt(ImStr label, int* v, float v_speed, int v_min, int v_max, ImStr display_format)
{
...
CIMGUI_API bool igTreeNodeStr1(ImStr str_label_id, ImStr text)
{
    return ImGui::TreeNode(str_label_id, text);
}
...
CIMGUI_API bool igListBoxHeader(ImStr label, CONST ImVec2 size)
{
...
CIMGUI_API void igValueColor(ImStr prefix, CONST ImVec4 v)
{
