...
CIMGUI_API void ImDrawList_AddText(ImDrawList* list, CONST struct ImVec2 pos, ImU32 col, ImStr text)
{
	return list->AddText(pos, col, text);
}

CIMGUI_API void ImDrawList_AddTextExt(ImDrawList* list, CONST ImFont* font, float font_size, CONST struct ImVec2 pos, ImU32 col, ImStr text, float wrap_width, CONST ImVec4* cpu_fine_clip_rect)
{
	return list->AddText(font, font_size, pos, col, text, wrap_width, cpu_fine_clip_rect);
}
